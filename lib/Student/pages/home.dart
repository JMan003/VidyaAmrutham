...
class StudentHome extends StatelessWidget {
  ...
  Future getDetails() async {
    ...
    final announcements = await http.get(Uri.parse('https://$url/announcements'));
                            ...
                            child: Container(
                              ...
                              child: Stack(
                                ...
                                children: [
                                  Center(
                                    child: Text(
                                      "${(data["attendance"]["result"]["present"] / data["attendance"]["result"]["total"] * 100).toString()} %",
                                      style: TextStyle(
                            ...
                            children: [
                              Center(
                                child: SingleChildScrollView(
                                  ...
                                  child: Column(
                                    children: [
                                      for (var announcement in data["announcements"]["result"])
                                        Card(
                                          margin: const EdgeInsets.all(10),
                                          child: ListTile(
                                            leading: const Icon(Icons.campaign, size: 25),
                                            title: Text(
